...
router.post("/image", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var image, start, aaaurl;
    return __generator(this, function (_a) {
        image = req.body.image;
        if (!image)
            return [2 /*return*/, res.status(404).send({ msg: "Cannot Find image Body Must Be URL" })];
        start = Date.now();
        try {
            aaaurl = new url_1.URL(image);
        ...
        try {
            (0, tesseract_js_1.recognize)(image, "eng", // export as english language
            {
                errorHandler: function (ar) {
