...
router.put("/delete", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, bins_1.default.findOne({ Token: Token })];
            case 1:
                data = _a.sent();
                if (!data) {
                    return [2 /*return*/, res.status(404).json({
                ...
                if (data.password !== null) {
                    ...
                    if (password === data.password) {
                        return [2 /*return*/, bins_1.default
                                .findOneAndDelete({
                                Token: Token,
                            })
                                .then(function () {
